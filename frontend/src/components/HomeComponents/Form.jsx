...
const Form = () => {
  return (
    <div className='bg-cover flex justify-center items-center w-full h-[100vh]'>
        <img src={bg} alt="" className='h-[100vh]   absolute -z-50' />
        <div className="bg-[#F5F5F5] rounded-3xl w-[80%] p-10 grid grid-cols-2 gap-10">
            <div>
                <h1 className='text-6xl font-bold mb-4'>Sign up to our Newsletter</h1>
