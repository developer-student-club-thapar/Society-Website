  ...
  return (
    <div className='flex justify-center items-center  flex-col'>
        <div className=" w-[90%] lg:w-[80%] flex flex-col justify-center items-center">
            ...
            <h1 className=' text-3xl lg:text-6xl font-semibold mt-6 projectsAnim'>Our Projects</h1>
            <p className= ' w-[80%] lg:w-[60%] text-gray-500 text-center lg:text-md text-sm mt-3 mb-10 projectsAnim'> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptates numquam quis iste vitae autem accusantium asperiores, aperiam laborum nemo perspiciatis a laudantium ?</p>
