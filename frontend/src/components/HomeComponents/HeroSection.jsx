...
const HeroSection = () => {
  return (
    <div className='flex justify-center items-center flex-col h-[50vh] lg:h-[80vh] '>
        <img src={heroImage} alt="hero" className=' absolute -z-20 heroimg' />
        
        <div className=" w-[80%] justify-center items-center flex flex-col">
            <h2 className='text-gray-600 text-[10px] text-center lg:text-sm font-light mb-4 mt-10 lg:mt-8'>Google Developer Students Club Thapar University</h2>
            <h1 className=' text-2xl lg:text-8xl text-center font-bold text-gray-900'>Empower Your Future With Innovation</h1>
