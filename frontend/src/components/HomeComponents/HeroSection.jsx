  ...
  return (
    <div className='flex justify-center items-center flex-col h-[80vh] '>
        ...
        <div className=" w-[80%] justify-center items-center flex flex-col">
            <h2 className='text-gray-600 font-light mb-4 mt-8 lg:text-sm text-xs text-center'>Google Developer Students Club Thapar University</h2>
            <h1 className=' text-2xl lg:mt-0 mt-2 lg:text-8xl text-center font-bold text-gray-900'>Empower Your Future With Innovation</h1>
