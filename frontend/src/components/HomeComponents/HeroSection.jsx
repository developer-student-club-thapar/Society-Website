...
const HeroSection = () => {
  return (
    <div className='flex justify-center items-center flex-col h-[80vh] '>
        <img src={heroImage} alt="hero" className=' absolute -z-20' />
        <div className=" w-[80%] justify-center items-center flex flex-col">
            <h2 className='text-gray-600 font-semibold mb-4 mt-8'>Google Developer Students Club Thapar University</h2>
